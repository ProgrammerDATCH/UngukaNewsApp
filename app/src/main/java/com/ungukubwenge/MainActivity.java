    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkRun = new Runnable() {
            ...
            public void run() {
                ...
                {
                    Toast.makeText(MainActivity.this, "No internet Connection to load UNGUKA Ubwenge Server!", Toast.LENGTH_LONG).show();
                    checkConn.postDelayed(checkRun, 10000);
                }
                else
                {
                    Toast.makeText(MainActivity.this, "Connected to UNGUKA Ubwenge Server", Toast.LENGTH_SHORT).show();
                    //good
